...
impl Store {
    ...
    #[inline]
    pub fn new_quicklist(&self) -> super::quicklist::QuickList {
        let fill = self.encoding.read().list_max_listpack_size;
        super::quicklist::QuickList::with_fill(fill)
    }
    ...
    pub fn exists_with_lazy_expire(&self, key: &[u8]) -> (bool, bool) {
        ...
        {
            super::dashtable::Entry::Occupied(e) => {
            ...
            super::dashtable::Entry::Vacant(_) => (false, false),
        }
    }
    ...
    pub fn expire(&self, key: &[u8], ms: i64) -> bool {
        ...
        match self
            ...
            .entry(h, |kv| kv.0 == key, |kv| calculate_hash(&kv.0))
        {
            super::dashtable::Entry::Occupied(mut e) => {
            ...
            super::dashtable::Entry::Vacant(_) => false,
        }
    }
    ...
    pub fn pttl(&self, key: &[u8]) -> i64 {
            ...
            .entry(h, |kv| kv.0 == key, |kv| calculate_hash(&kv.0))
        {
            ...
            super::dashtable::Entry::Vacant(_) => -2,
        }
    }
    ...
    pub fn get_version(&self, key: &[u8]) -> Option<u64> {
            ...
            .entry(h, |kv| kv.0 == key, |kv| calculate_hash(&kv.0))
        {
            ...
            super::dashtable::Entry::Vacant(_) => None,
        }
    }
    ...
    fn is_key_expired(&self, key: &[u8]) -> bool {
        ...
        match self
            ...
            .entry(h, |kv| kv.0 == key, |kv| calculate_hash(&kv.0))
        {
            super::dashtable::Entry::Occupied(e) => e.get().1.is_expired(),
            super::dashtable::Entry::Vacant(_) => false,
        }
    }
...
mod tests {
    use super::*;
    use crate::redis::stream::storage::DataType;
